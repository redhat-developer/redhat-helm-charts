...
4. Ensure that the docker images for IBM Sterling B2B Integrator Software Enterprise Edition from Passport Advantage are loaded to an appropriate docker registry.
