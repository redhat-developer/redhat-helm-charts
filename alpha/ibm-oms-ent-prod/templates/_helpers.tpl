...
{{- $ctxRoot := .}}
{{- if $ctxRoot }}
{{ printf "echo %s : %s/%s" $ctxRoot.path $baseURL $ctxRoot.path | quote }}
{{- end }}
{{- end }}
{{- end -}}
...
{{- $ctxRoot := .}}
{{- if $ctxRoot }}
{{ printf "echo %s : %s://%s.%s.%s/%s" $ctxRoot.routePrefix $protocol $ctxRoot.routePrefix $varRoot.Release.Name $host $ctxRoot.path | quote }}
{{- end }}
{{- end }}
{{- end -}}
